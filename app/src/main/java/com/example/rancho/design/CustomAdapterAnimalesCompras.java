...
public class CustomAdapterAnimalesCompras extends BaseAdapter {
    ...
    public CustomAdapterAnimalesCompras(Context context, ArrayList<Animales> listaAnimales) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null){
            convertView = LayoutInflater.from(context).inflate(R.layout.cardview_animales,
                    parent, false);
        ...
        storageRef.child(lista.getId()+".jpg");
